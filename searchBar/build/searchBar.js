...
var ProductCategoryRow = React.createClass({displayName: "ProductCategoryRow",
	render: function() {
		console.log("123");
		return ( React.createElement("tr", null, React.createElement("th", {colSpan: "2"}, 
		this.props.category
		)) )
	}
});
...
var ProductRow = React.createClass({displayName: "ProductRow",
	render: function() {
		...
		return ( 
			...
			React.createElement("td", null, name), React.createElement("td", null, this.props.product.price)
			)
		);
	}
});
	...
	render: function(){
		return (
			React.createElement("form", null, 
				React.createElement("input", {type: "text", placeholder: "Search...", ref: "filterTextInput", value: this.props.filterText, onChange: this.handleChange}), 
				React.createElement("p", null, 
					React.createElement("input", {type: "checkbox", ref: "inStockOnlyInput", checked: this.props.inStockOnly, onChange: this.handleChange}), 
					' ', 
	...
	render: function(){
		return (
			React.createElement("div", null, 
				React.createElement(SearchBar, {filterText: this.state.filterText, inStockOnly: this.state.inStockOnly, handleChange: this.handleChange}), 
