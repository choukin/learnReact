...
export default class NewsItem extends React.Component{
	...
	getTitle(){
		var itemurl = this.props.item.url?this.props.item.url:'https://news.ycombinator.com/item?id=' + this.props.item.id;
		return (
	...
	getCommentLink(){//评论链接
		...
		if(this.props.item.kids && this.props.item.kids.length){
			commentText = this.props.item.kids.length +' commnet';
		}
	...
	getSubtext(){
		return (
			<div className="newsItem-subtext">
				...
				<a href={'https://news.ycombinator.com/user?'+this.props.item.by}>
				{this.props.item.by}
				</a>
	...
	getVote(){
		return (
			<div className="newsItem-vote">
				<a href={'https://news.ycombinator.com/vote?for='+this.props.id+"&dir=up&goto=news"}>
